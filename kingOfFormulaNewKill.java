...
public class kingOfFormulaNewKill {

	// private static int wantTerm = 2019073;
	private static int wantTerm = 20001;

	private static int selectedRedCnt = 5;
	private static int redCnt = 35;
	private static int testTerm = 80;
	private static int minRightTerm = 80;
	...
	private static String historyFile = "dlt.txt";
	...
	private static void twoFInSameRow(int start, ArrayList<ArrayList<Integer>> arrCon) {
		...
		for (int j = 0; j < selectedRedCnt - 1; j++) {
			for (int j1 = j + 1; j1 < selectedRedCnt; j1++) {
				for (int row1 = start - 1; row1 > -1; row1--) {

					for (int k = 0; k < redCnt + 1; k++) {
						ArrayList<Integer> rightArr = new ArrayList<Integer>();
	...
	private static void twoFInNotSameRow(int start, ArrayList<ArrayList<Integer>> arrCon) {

		for (int j = 0; j < selectedRedCnt; j++) {
			for (int j1 = 0; j1 < selectedRedCnt; j1++) {
	...
	private static int forecastWant(int strTerm) {
